    ...
    <div className="space-y-5">
      ...
      <section className="space-y-3">
        <StatRow
          ...
          value="91%"
          body="Out of 100 field scans, AgriScout correctly identifies problems 91 times — trust the alerts you see."
        />
        <StatRow
          icon={ShieldCheck}
          title="False alarms"
        ...
        <ul className="mt-3 space-y-2.5 text-sm leading-relaxed text-white/75">
          <li className="flex gap-2">
            ...
            <span>
              ...
              AgriScout tells you exactly where to look instead of walking the
              whole farm daily.
            </span>
          </li>
          <li className="flex gap-2">
